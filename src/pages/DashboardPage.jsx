...
import { VentasGraf } from "../components/Dashboard/VentasGraf";
import ProductosMasVendidosList from "../components/Dashboard/ProductosMasVendidosList";
import ProductosMenosVendidosList from "../components/Dashboard/ProductosMenosVendidos";
  ...
  return (
    ...
    >
      <section className="flex flex-wrap justify-evenly gap-4 p-4 ">
        ...
        <LineComprasVentas color={"bg-[#4ea93b]"} />
        <TopVendidos color={"bg-[#4ea93b]"} />
      </section>
    </div>
  );
};
